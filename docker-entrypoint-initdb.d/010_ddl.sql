...
CREATE TABLE IF NOT EXISTS fixtures (
  id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  tournament_id INT REFERENCES tournaments ON DELETE CASCADE,
  home INT REFERENCES tournament_participants ON DELETE CASCADE,
  away INT REFERENCES tournament_participants ON DELETE CASCADE,
  ...
  UNIQUE (home, away, kickoff)  -- countries can only play each other once at the same time
);
